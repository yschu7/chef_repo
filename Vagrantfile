...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "yschu7-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/yschu7"
  #   chef.validation_client_name = "yschu7-validator"
  #   chef.validation_key_path = ".chef/yschu7-validator.pem"
  # end
end
